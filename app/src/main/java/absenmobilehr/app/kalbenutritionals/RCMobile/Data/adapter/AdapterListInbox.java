package absenmobilehr.app.kalbenutritionals.RCMobile.Data.adapter;
...
import absenmobilehr.app.kalbenutritionals.RCMobile.Data.common.Inbox;
...
public class AdapterListInbox extends RecyclerView.Adapter<AdapterListInbox.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            super(view);
            from = (TextView) view.findViewById(R.id.Category);
            email = (TextView) view.findViewById(R.id.ActivityDescription);
            message = (TextView) view.findViewById(R.id.statusVerify);

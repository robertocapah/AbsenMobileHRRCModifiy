...
//    public String linkDownloadApk = "files/HRISMobileKN.apk";
    ...
    public static final String EMOT_SAD = "Sad";
    public static final String EMOT_TIRED = "Tired";
    public static final String EMOT_SATISFIED = "Satisfied";
    public static final String EMOT_EXITED = "Excited";
    public static final String EMOT_HAPPY = "Happy";

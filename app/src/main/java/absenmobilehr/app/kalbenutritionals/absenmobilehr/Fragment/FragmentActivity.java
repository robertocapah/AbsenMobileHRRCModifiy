...
import absenmobilehr.app.kalbenutritionals.absenmobilehr.Data.adapter.AdapterListActivity;
import absenmobilehr.app.kalbenutritionals.absenmobilehr.Data.clsHardCode;
import absenmobilehr.app.kalbenutritionals.absenmobilehr.Data.common.Event;
...
import absenmobilehr.app.kalbenutritionals.absenmobilehr.lib.SpinnerCustom;
import absenmobilehr.app.kalbenutritionals.absenmobilehr.lib.clsDatePicker;
import absenmobilehr.app.kalbenutritionals.absenmobilehr.utils.Tools;
import absenmobilehr.app.kalbenutritionals.absenmobilehr.widget.LineItemDecoration;

import static absenmobilehr.app.kalbenutritionals.absenmobilehr.lib.clsDatePicker.formatSimpleDate;
...
//                                ToastCustom.showToasty(context,warn, 2);
    ...
    private void enableActionMode(int position, clsActivityUser obj) {
        if (obj.getIntFlag() == 2 && obj.getIntStatus() ==6) {
...
//                                                    ToastCustom.showToasty(context,warn, 2);
                        ...
                        bt_submit.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                ...
                                alertDialog.setTitle("Add unplan activity");
